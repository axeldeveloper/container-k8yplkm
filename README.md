...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-k8yplkm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-k8yplkm.containers.anotherwebservice.com/
...
```
git clone git@github.com:axeldeveloper/container-k8yplkm.git
cd container-k8yplkm
```
...
```
docker attach container-k8yplkm
```
